(function () {
  ...
  var LABELS = {
    want_to_go: ['Save to my journey', '✓ Saved to my journey'],
  ...
  // Client-side markup builder mirroring pilgrims/templates/community/_journey_buttons.html,
  // for callers (like the interactive map) that build popups/cards from JSON
